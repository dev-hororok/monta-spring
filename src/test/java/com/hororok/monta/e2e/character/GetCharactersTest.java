...
public class GetCharactersTest {
    ...
    @DisplayName("성공")
    @Test
    public void getCharactersByAdmin() {
        ExtractableResponse<Response> extractableResponse = returnExtractableResponse("Admin");
        GetCharactersResponseDto response = extractableResponse.as(GetCharactersResponseDto.class);
    ...
    @Test
    public void getCharactersByUser() {
    ...
    @Test
    public void getCharactersByElse() {
